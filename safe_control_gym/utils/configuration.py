...
class ConfigFactory:
    ...
    def add_arguments(self):
        ...
        self.add_argument(
            "--experiment_type", type=str, default="basic", help="type of experiment to run"
        )
        ...
        self.add_argument("--overrides", nargs="+", type=str, help="override config files")
        self.add_argument("--kv_overrides", nargs="+", type=str, help="override key-value pairs")
