...
class ExperimentLogger:
    ...
    def __init__(self, log_dir, log_std_out=True, log_file_out=False, use_tensorboard=False):
        """Initializes loggers.
    ...
    def add_scalars(self, data, step, prefix=None, store=True, write=True, write_tb=True):
