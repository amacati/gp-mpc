...
config = fac.merge()
if generalization:
    config.task_config.task_info.ilqr_traj_data = (
        "/home/mingxuan/Repositories/scg_tsung/examples/lqr/ilqr_ref_traj_gen.npy"
    )
...
gp_model_dirs = [
    d for d in os.listdir(gp_model_path) if os.path.isdir(os.path.join(gp_model_path, d))
]
...
if not generalization:
    ilqr_data_path = (
        "/home/mingxuan/Repositories/scg_tsung/benchmarking_sim/quadrotor/ilqr/results/temp"
    )
if generalization:
    ilqr_data_path = (
        "/home/mingxuan/Repositories/scg_tsung/benchmarking_sim/quadrotor/ilqr/results_rollout/temp"
    )

ilqr_data_dirs = [
    d for d in os.listdir(ilqr_data_path) if os.path.isdir(os.path.join(ilqr_data_path, d))
]
...
if not generalization:
    lmpc_data_path = (
        "/home/mingxuan/Repositories/scg_tsung/benchmarking_sim/quadrotor/linear_mpc/results/temp"
    )
if generalization:
    lmpc_data_path = "/home/mingxuan/Repositories/scg_tsung/benchmarking_sim/quadrotor/linear_mpc/results_rollout/temp"
lmpc_data_dirs = [
    d for d in os.listdir(lmpc_data_path) if os.path.isdir(os.path.join(lmpc_data_path, d))
]
...
if not generalization:
    mpc_data_path = (
        "/home/mingxuan/Repositories/scg_tsung/benchmarking_sim/quadrotor/mpc_acados/results/temp"
    )
if generalization:
    mpc_data_path = "/home/mingxuan/Repositories/scg_tsung/benchmarking_sim/quadrotor/mpc_acados/results_rollout/temp"
mpc_data_dirs = [
    d for d in os.listdir(mpc_data_path) if os.path.isdir(os.path.join(mpc_data_path, d))
]
...
if not generalization:
    ppo_data_path = (
        "/home/mingxuan/Repositories/scg_tsung/benchmarking_sim/quadrotor/data/traj_results_ppo.npy"
    )
else:
...
if not generalization:
    sac_data_path = (
        "/home/mingxuan/Repositories/scg_tsung/benchmarking_sim/quadrotor/data/traj_results_sac.npy"
    )
else:
...
if plot_name == "RL":
    plot_xz_trajectory_with_hull(
        ...
        dppo_traj_data,
        label="DPPO",
        traj_color=dppo_color,
        hull_color=dppo_hull_color,
        alpha=alpha,
        padding_factor=k,
    )
    plot_xz_trajectory_with_hull(
        ...
        sac_traj_data,
        label="SAC",
        traj_color=sac_color,
        hull_color=sac_hull_color,
        alpha=alpha,
        padding_factor=k,
    )
    ...
    plot_xz_trajectory_with_hull(
        ...
        ppo_traj_data,
        label="PPO",
        traj_color=ppo_color,
        hull_color=ppo_hull_color,
        alpha=alpha,
        padding_factor=k,
    )
    ...
    plot_xz_trajectory_with_hull(
        ...
        lmpc_traj_data,
        label="Linear-MPC",
        traj_color=lmpc_color,
        hull_color=lmpc_hull_color,
        alpha=alpha,
        padding_factor=k,
    )
    plot_xz_trajectory_with_hull(
        ...
        mpc_traj_data,
        label="MPC",
        traj_color=mpc_color,
        hull_color=mpc_hull_color,
        alpha=alpha,
        padding_factor=k,
    )
    plot_xz_trajectory_with_hull(
        ...
        gpmpc_traj_data,
        label="GP-MPC",
        traj_color=gpmpc_color,
        hull_color=gpmpc_hull_color,
        alpha=alpha,
        padding_factor=k,
    )
...
if not generalization:
    fig.savefig(
        os.path.join(script_path, f"{plot_name}_xz_path_performance.png"), bbox_inches="tight"
    )
    print(f'Saved at {os.path.join(script_path, f"{plot_name}_xz_path_performance.png")}')
else:
    fig.savefig(
        os.path.join(script_path, f"{plot_name}_xz_path_generalization.png"), bbox_inches="tight"
    )
